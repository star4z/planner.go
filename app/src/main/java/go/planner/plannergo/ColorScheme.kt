        ...
        init {
            ...
            val lightColors = object : HashMap<Field, Int>() {
                init {
                    ...
                    put(Field.MAIN_BG, R.color.lightPrimaryDark)
                    put(Field.MAIN_HEADER, R.color.textBlack)
                    put(Field.MAIN_CARD_BG, R.color.lightPrimary)
            ...
            val darkColors = object : HashMap<Field, Int>() {
                init {
                    ...
                    put(Field.IP_APP_BAR_OPT, R.drawable.ic_more_vert_white_24dp)
                    ...
                    put(Field.CP_APP_BAR_OPT, R.drawable.ic_more_vert_white_24dp)
                    ...
                    put(Field.TR_APP_BAR_OPT, R.drawable.ic_more_vert_white_24dp)
                    ...
                    put(Field.HF_BG, R.color.darkPrimary)
                    ...
                    put(Field.MAIN_BUTTON_BG, R.color.lightAccent)
                    put(Field.MAIN_BUTTON_FG, R.color.textBlack)
                    put(Field.LS_APP_BAR_BG, R.color.darkPrimary)
